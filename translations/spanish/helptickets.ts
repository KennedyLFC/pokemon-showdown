...
export const translations: Translations = {
	strings: {
		...
		"I want to appeal a mute/roomban/blacklist": "Quiero apelar un mute/roomban/blacklist",
		...
		"Hi! All global staff members are busy right now and we apologize for the delay. ": "Hola! En este momento los miembros del staff global están ocupados, disculpa la demora",
		"Please make sure you have given us the permission to check the PMs between you and the user you reported. You can also provide any relevant context; for example, a replay of a battle with the person you're reporting.": "Por favor asegúrate de habernos dado permido para revisar los mensajes privados (PMs) entre el usuario que reportaste y tú. También puedes agregar contexto relevante, como por ejemplo una replay de una batalla contra este usuario.",
		'Please save the replay of the battle and provide a link to it in this chat, so we can see the harassment even if the battle expires. You can save the replay by clicking on the "Upload and share replay" button once the battle has ended.': 'Por favor guarda la replay de la batalla y adjunta un link a esta en este chat, para que podamos revisar el acoso incluso si la batalla expira. Puedes guardar la replay al seleccionar el botón "Upload and share replay" una vez que la batalla terminó.',
		"Make sure you have provided the correct username, and if its meaning or why it is offensive is not obvious, please explain why it should not be allowed.": "Por favor asegúrate de haber reportado el nombre correcto, y si su significado o por qué es ofensivo no es algo obvio, por favor explica por qué no debería estar permitido.",
		'Please save the replay of the battle and provide a link to it in this chat, so we can see the nicknames even if the battle expires. You can save the replay by clicking on the "Upload and share replay" button once the battle has ended.': 'Por favor guarda la replay de la batalla y adjunta un link a esta en este chat, para que podamos revisar los motes incluso si la batalla expira. Puedes guardar la replay al seleccionar el botón "Upload and share replay" una vez que la batalla terminó',
		"Please clearly explain why you should be unlocked and we will review it as soon as possible.": "Por favor explica claramente por qué deberíamos quitar tu lock, y revisaremos tu caso lo más pronto posible.",
		"Please give us all relevant information on how you are connecting to Pokémon Showdown (if it is through mobile data, at home, a school or work network, etc), and we will review your case as soon as possible.": "Por favor ofrece toda la información relevante respecto a cómo te conectas a Pokémon Showdown (si es a través de datos móviles, si es en tu hogar, en el colegio, mediante una conexión del trabajo, etc), y revisaremos tu caso lo antes posible.",
		"Please tell us which room you need assistance with and a global staff member will join your room as soon as possible.": "Por favor dinos en cuál sala necesitas ayuda y un miembro del staff global entrará a tu sala lo más pronto posible.",
		"If your issue pertains to battle mechanics or is a question about Pokémon Showdown, you can ask in the <<help>> chatroom.": "Si tu problema tiene que ver con mecánicas de batalla o es una pregunta sobre Pokémon Showdown, puedes hacerla en la sala <<help>>",
	},
};
